...
<head>
    <meta charset="utf-8" />
    <title>
        CMARS National Referral hospitals
    </title>
...
<body>
    ...
    <h2>National referral hospitals</h2>
    ...
    <div class="main">
        <div>
            ...
            <a href="/national referral hospitals" class="link" style="color: black; font-weight: bold; background-color: white;">National</a>
        </div>
        <br>
        <table>
            <tr>
